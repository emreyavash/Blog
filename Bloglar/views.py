...
class BlogByCategoryListView(ListView):
    ...
    def get_queryset(self,*args, **kwargs):
        ...
        return Blog.objects.filter(category = categoryid )
...
def blogComment(request,id):
    ...
    if request.method =="POST":
        ...
        commentBlog = BlogComment.objects.create(sender_name = name,sender_email = email,comment = comment,blog_id=blog_id.id)
        commentBlog.save()
