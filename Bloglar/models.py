...
class Blog(models.Model):
    ...
    create_blog_date = models.DateTimeField(editable=False,auto_now_add=True)
...
class SliderBlog(models.Model):
    ...
    create_slider_date = models.DateTimeField(editable=False,auto_now_add=True)
...
class BlogComment(models.Model):
    ...
    created_commnet_date = models.DateTimeField(auto_now_add=True,editable=False)
